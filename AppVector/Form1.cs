...
namespace APPVector
{
    ...
    {   
        ...
        private void cantidadDeCapicuaToolStripMenuItem_Click(object sender, EventArgs e)
        {
            int c = v.CantElementoCapicua();
            MessageBox.Show("Cant. de Elementos Capicua: " + c.ToString());
        }

        private void cantidadDePrimosToolStripMenuItem_Click(object sender, EventArgs e)
        {
            int c = v.CantElementoPrimo();
            MessageBox.Show("Cant. de Elementos Primos: " + c.ToString());
        }

        private void invertirElementoVectorToolStripMenuItem_Click(object sender, EventArgs e)
        {
